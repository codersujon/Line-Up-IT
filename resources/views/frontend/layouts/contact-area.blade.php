                ...
                <form action="#">
                    <div class="contact-area-wrapper">
                        <div class="section-title mb-50">
                            <h2>যোগাযোগ</h2>
                            <h4>ফ্রিল্যান্সিং সংক্রান্ত যেকোনো সমস্যা সমাধানের জন্য চলে আসুন আমাদের অফিসে</h4>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="contact-from-input mb-20">
                                <input type="text" placeholder="আপনার নাম (আবশ্যিক)">
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="contact-from-input mb-20">
                                <input type="text" placeholder="ফোন নাম্বার (আবশ্যিক)">
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="contact-from-input mb-20">
                                <input type="text" placeholder="ইমেইল অ্যাড্রেস (আবশ্যিক)">
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="contact-select">
                                <select class="mb-20">
                                    <option value="Subject">কোর্স সম্পর্কে</option>
                                    <option value="Subject">ফিন্যাসিয়াল এইড</option>
                                    <option value="Subject">পেমেন্ট</option>
                                    <option value="Subject">ইনফরমেশন</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-xl-12">
                            <div class="contact-from-input mb-20">
                                <textarea placeholder="আপনার ম্যাসেজ এখানে বিস্তারিত লিখুন" name="message"></textarea>
                            </div>
                        </div>
                        <div class="colxl-2 ">
                            <div class="cont-btn mb-20">
                                <a href="#" class="cont-btn">পাঠান</a>
                            </div>
                        </div>
                        ...
                        <div class="support-contact-inner">
                            <div class="support-item">
                                ...
                                <div class="support-info-phone">
                                    <span>Phone</span>
                                    <p>Hotline :<br>
                                        <a href="tel:(+88)422-655-793"> (+88) 01773 599 145</a><br>
                                        <a href="tel:(+88)872-670-780"> (+880) 1886 599 146</a>
                                    </p>
                                    <p>Mobile :<br>
                                        <a href="tel:(+88)872-670-780"> (+880) 1970 366 446</a><br>
                                        <a href="tel:(+88)872-670-780"> (+880) 1845 889 865</a>
                                    </p>
                                </div>
                            </div>
                            <div class="support-item">
                                ...
                                <div class="support-info-email">
                                    <span>Email</span>
                                    <a href="mailto:Info@example.com">lineupitbd@gmail.com</a>
                                    <a href="mailto:Contact@example.com">support@lineupit.com</a>
                                </div>
                            </div>
                            <div class="support-item">
                                <div class="support-icon">
                                ...
                                <div class="support-info-location">
                                    <span>Location</span>
                                    <a href="#">১০৬-১১৪ শহীদ ফারুক রোড, যাত্রাবাড়ী,<br>
                                        ঢাকা-১২০৪</a>
                                </div>
                            </div>
                        </div>
