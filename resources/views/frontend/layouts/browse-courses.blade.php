    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-12 mb-30">
                <div class="browser-course-wrapper course-height" data-background="">
                    <div class="browser-course-bg">
                        <img src="{{asset('frontend')}}/img/browser-course/browser-course-01.jpg" alt="image not found">
                    </div>
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 mb-30">
                <div class="browser-course-wrapper course-height" data-background="">
                    <div class="browser-course-bg">
                        <img src="{{asset('frontend')}}/img/browser-course/browser-course-02.jpg" alt="image not found">
                    </div>
                    <div class="row">
