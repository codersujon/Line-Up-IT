                 ...
                 <ul>
                     <li>
                         <div class="cartmini__thumb">
                             <a href="course.html">
                                 <img src="{{asset('frontend')}}/img/products/product-thumb-01.png"
                                     alt="image not found">
                             </a>
                         </div>
                     ...
                     <li>
                         <div class="cartmini__thumb">
                             <a href="course.html">
                                 <img src="{{asset('frontend')}}/img/products/product-thumb-02.png"
                                     alt="image not found">
                             </a>
                         </div>
                         <div class="cartmini__content">
                     ...
                     <li>
                         <div class="cartmini__thumb">
                             <a href="course.html">
                                 <img src="{{asset('frontend')}}/img/products/product-thumb-03.png"
                                     alt="image not found">
                             </a>
                         </div>
                         <div class="cartmini__content">
