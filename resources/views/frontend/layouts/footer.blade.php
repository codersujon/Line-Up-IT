                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                        <div class="footer-widget f-w1 mb-40">
                            <div class="footer-img">
                                <a href="index.html"> <img src="{{asset('frontend')}}/img/logo/footer-logo.png"
                                        alt="footer-logo"></a>
                                <p>আপনি যদি বিশ্বস্তার সাথে আপনার একটি অনলাইন ক্যারিয়ার গড়তে চান তাহলে লাইন-আপ আইটি ইন্সটিটিউট হতে পারে আপনার জন্য একটি নির্ভরযোগ্য প্রতিষ্ঠান।</p>
                            </div>
                            <div class="footer-icon">
                                <a href="https://www.facebook.com/LineUpITInstitute" target="_blank"><i class="fab fa-facebook-f"></i></a>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                        <div class="footer-widget f-w3 mb-40">
                            <h3>কোর্সসমূহ</h3>
                            <ul>
                                <li><a href="#">বেসিক কম্পিউটার এন্ড অফিস স্পেশালিস্ট</a></li>
                                <li><a href="#">প্রফেশনাল গ্রাফিক্স ডিজাইন</a></li>
                                <li><a href="#">ডিজিটাল মার্কেটিং  উইথ ফ্রিল্যান্সিং</a></li>
                                <li><a href="#">স্পোকেন ইংলিশ</a></li>
                                <li><a href="#">ওয়েব ডিজাইন</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                        <div class="footer-widget f-w4 mb-40">
                            ...
                            <ul>
                                ...
                                <li><a href="#">প্রাইভেসি নীতিমালা</a></li>
                                <li><a href="#">অর্থ ফেরত / বাতিল নীতিমালা</a></li>
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                            <div class="copyright-text border-line">
                                <p>স্বত্ব  &copy; {{date('Y')}} <br> <a href="http://www.lineupit.com/"><span>লাইন-আপ আইটি ইন্সটিটিউট কর্তৃক সর্বস্বত্ব সংরক্ষিত </span></a> </p>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-sm-6">
                            <div class="copy-right-support border-line-2">
                                            ...
                                            <g id="Group_2171" data-name="Group 2171"
                                                ...
                                                <g id="Group_2170" data-name="Group 2170">
                                                    <path id="Path_2983" data-name="Path 2983"
                                                        ...
                                                        transform="translate(-91 -210)" fill="#ec3227" />
                                                </g>
                                            </g>
                                            <g id="Group_2173" data-name="Group 2173" transform="translate(31 23.669)">
                                                <g id="Group_2172" data-name="Group 2172">
                                                    <path id="Path_2984" data-name="Path 2984"
                                                        ...
                                                        transform="translate(-31 -242.366)" fill="#ec3227" />
                                                </g>
                                            </g>
                                            <g id="Group_2175" data-name="Group 2175"
                                                ...
                                                <g id="Group_2174" data-name="Group 2174">
                                                    <path id="Path_2985" data-name="Path 2985"
                                                        ...
                                                        transform="translate(-211 -210)" fill="#ec3227" />
                                                </g>
                                            </g>
                                            <g id="Group_2177" data-name="Group 2177"
                                                ...
                                                <g id="Group_2176" data-name="Group 2176">
                                                    <path id="Path_2986" data-name="Path 2986"
                                                        ...
                                                        transform="translate(-449.722 -242.366)" fill="#ec3227" />
                                                </g>
                                            </g>
                                            <g id="Group_2179" data-name="Group 2179" transform="translate(31)">
                                                <g id="Group_2178" data-name="Group 2178">
                                                    <path id="Path_2987" data-name="Path 2987"
                                                        ...
                                                        transform="translate(-31)" fill="#ec3227" />
                                                </g>
                                            </g>
                                        </g>
                                    </svg>
                                ...
                                <div class="copyright-svg-content">
                                    ...
                                    <h5><a href="tel:(987)547587587">(+880) 177 35 99 145</a></h5>
                                </div>
                            </div>
                        </div>
