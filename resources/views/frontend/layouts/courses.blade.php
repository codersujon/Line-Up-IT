<!-- course main area start  -->
<section class="course-area p-relative pt-110 pb-90">
    <div class="course-shape-1">
        <img src="{{asset('frontend')}}/img/shape/portfolio-shap-1.png" alt="shape">
    </div>
    <div class="course-shape-2">
        <img src="{{asset('frontend')}}/img/shape/portfolio-shap-2.png" alt="shape">
    </div>
    <div class="course-shape-3">
        <img src="{{asset('frontend')}}/img/shape/portfolio-shap-3.png" alt="shape">
    </div>
    <div class="container">
        <div class="row">
            <div class="col-xl-5 col-lg-5 f-left">
                <div class="section-title mb-50">
                    <h2>আমাদের <br>
                        <span class="down-mark-line">কোর্সসমূহ</span></h2>
                </div>
            </div>
        ...
        <div class="row grid course-main-items">
            <div class="col-xl-4 col-lg-4 col-md-6 grid-item c-2">
                <div class="eduman-course-main-wrapper mb-30">
                    ...
                    <div class="eduman-course-thumb w-img">
                        <a href="course-details.html"><img src="{{asset('frontend')}}/img/portfilo/course-img-01.jpg"
                                alt="course-img"></a>
                    </div>
                    <div class="eduman-course-wraper">
                        ...
                        <div class="eduman-course-meta">
                            ...
                            <div class="eduman-course-tutor"><img
                                    src="{{asset('frontend')}}/img/portfilo/course-tutor-01.png" alt="image not found">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 grid-item c-2">
                <div class="eduman-course-main-wrapper mb-30">
                    ...
                    <div class="eduman-course-thumb w-img">
                        <a href="course-details.html"><img src="{{asset('frontend')}}/img/portfilo/course-img-02.jpg"
                                alt="course-img"></a>
                    </div>
                    <div class="eduman-course-wraper">
                        <div class="eduman-course-heading">
                        ...
                        <div class="eduman-course-meta">
                            ...
                            <div class="eduman-course-tutor">
                                <img src="{{asset('frontend')}}/img/portfilo/course-tutor-02.png" alt="image not found">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 grid-item c-3">
                <div class="eduman-course-main-wrapper mb-30">
                    ...
                    <div class="eduman-course-thumb w-img">
                        <a href="course-details.html"><img src="{{asset('frontend')}}/img/portfilo/course-img-03.jpg"
                                alt="course-img"></a>
                    </div>
                    <div class="eduman-course-wraper">
                        <div class="eduman-course-heading">
                        ...
                        <div class="eduman-course-meta">
                            ...
                            <div class="eduman-course-tutor">
                                <img src="{{asset('frontend')}}/img/portfilo/course-tutor-03.png" alt="image not found">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 grid-item c-2">
                <div class="eduman-course-main-wrapper mb-30">
                    ...
                    <div class="eduman-course-thumb w-img">
                        <a href="course-details.html"><img src="{{asset('frontend')}}/img/portfilo/course-img-05.jpg"
                                alt="course-img"></a>
                    </div>
                    <div class="eduman-course-wraper">
                        <div class="eduman-course-heading">
                        ...
                        <div class="eduman-course-meta">
                            ...
                            <div class="eduman-course-tutor">
                                <img src="{{asset('frontend')}}/img/portfilo/course-tutor-05.png" alt="image not found">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 grid-item c-1">
                <div class="eduman-course-main-wrapper mb-30">
                    ...
                    <div class="eduman-course-thumb w-img">
                        <a href="course-details.html"><img src="{{asset('frontend')}}/img/portfilo/course-img-06.jpg"
                                alt="course-img"></a>
                    </div>
                    <div class="eduman-course-wraper">
                        <div class="eduman-course-heading">
                        ...
                        <div class="eduman-course-meta">
                            ...
                            <div class="eduman-course-tutor">
                                <img src="{{asset('frontend')}}/img/portfilo/course-tutor-06.png" alt="image not found">
                                <a href="instructor-profile.html"><span>Mark Hanry</span></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 grid-item c-4">
                <div class="eduman-course-main-wrapper mb-30">
                    <div class="course-cart">
                        <div class="course-info-wrapper">
                            <div class="cart-info-body">
                                <span class="category-color category-color-4"><a href="course.html">Life
                                        Style</a></span>
                                <a href="course-details.html">
                    ...
                    <div class="eduman-course-thumb w-img">
                        <a href="course-details.html"><img src="{{asset('frontend')}}/img/portfilo/course-img-04.jpg"
                                alt="course-img"></a>
                    </div>
                    <div class="eduman-course-wraper">
                        <div class="eduman-course-heading">
                        ...
                        <div class="eduman-course-meta">
                            ...
                            <div class="eduman-course-tutor">
                                <img src="{{asset('frontend')}}/img/portfilo/course-tutor-04.png" alt="image not found">
                                <a href="instructor-profile.html"><span>Danial</span></a>
                            </div>
                        </div>
                    </div>
