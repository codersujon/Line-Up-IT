        ...
        <div class="row">
            ...
            <div class="col-xl-5 col-lg-5">
                <div class="student-choose-wrapper position-relative">
                    ...
                    <div class="shap-03">
                        <img src="{{asset('frontend')}}/img/shape/student-shape-03.png" alt="image not found">
                    </div>
                    <div class="shap-04">
                        <img src="{{asset('frontend')}}/img/shape/student-shape-04.png" alt="image not found">
                    </div>
                    <div class="shap-05">
                        <img src="{{asset('frontend')}}/img/shape/student-shape-05.png" alt="image not found">
                    </div>
                    <div class="shap-06">
                        <img src="{{asset('frontend')}}/img/shape/student-shape-06.png" alt="image not found">
                    </div>
                    <div class="shap-07">
                        <img src="{{asset('frontend')}}/img/shape/student-shape-07.png" alt="image not found">
                    </div>

                    <div class="student-choose-thumb">
                        <img src="{{asset('frontend')}}/img/student-choose/student.png" alt="image not found">
                    </div>
                </div>
            </div>
        </div>
